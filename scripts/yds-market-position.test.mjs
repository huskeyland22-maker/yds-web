...
assert(view?.metricsLine.includes("CNN 27"), view?.metricsLine)
assert(view?.metricsLine.includes("VIX 22.2"), view?.metricsLine)

const panic = resolvePanicActionView(40)
assert(panic?.scoreDisplay === "40 / 100", panic?.scoreDisplay)
