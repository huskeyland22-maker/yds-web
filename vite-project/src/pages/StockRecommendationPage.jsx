...
import YdsStockPickPageAlertButton from "../components/stock-picks/YdsStockPickPageAlertButton.jsx"
...
export default function StockRecommendationPage() {
  ...
  return (
    <div className="yds-spick-page yds-spick-page--countries min-w-0 px-3 py-4 sm:px-4">
      <header className="yds-spick-page__header yds-spick-page__header--with-alert">
        <div className="yds-spick-page__header-main">
        ...
        <YdsStockPickPageAlertButton className="yds-spick-page__alert" />
      </header>
