...
export const INTRO_SECTIONS = [
  {
    id: "what",
    title: "YDS란 무엇인가",
    body: "YDS는 공포·탐욕 지표를 YDS 총점(0–100) 하나로 읽고, 지금 어느 사이클 구간인지와 그에 맞는 행동을 보여 주는 시장 분석 도구입니다. 복잡한 차트보다 「지금 무엇을 준비하고, 언제 실행할지」를 먼저 전달합니다.",
  },
  {
    id: "why",
    title: "왜 만들었는가",
  ...
  },
  {
    id: "position",
    title: "YDS 총점 설명",
    body: "YDS 총점은 0~100 척도입니다. 낮을수록 과열에 가깝고, 높을수록 공포·매집 기회에 가깝습니다. 실전 기회는 주로 🟡 관심·🟠 분할매수 구간에서 발생하며, 🔴 패닉매수(80+)는 드문 보너스 구간입니다.",
  },
]
...
export const FAQ_ITEMS = [
  ...
  {
    q: "패닉매수란 무엇인가?",
    a: "YDS 5단계 중 가장 공포가 큰 보너스 구간(80+)입니다. 역사적으로 자주 오지 않으며, COVID급 극단도 분할매수(60–79)로 분류된 사례가 있습니다. 80+만을 기다리기보다 관심·분할매수에서 준비·실행하는 것이 YDS 철학입니다.",
  },
]
