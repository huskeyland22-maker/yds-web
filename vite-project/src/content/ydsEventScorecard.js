...
export const SCORECARD_EVENT_CONFIG = [
  ...
  { type: "momentum-cnn-day-shock", title: "투자심리 급변", winDirection: "up" },
  { type: "momentum-cnn-day-bounce", title: "투자심리 급회복", winDirection: "down" },
  { type: "momentum-cnn-crash", title: "투자심리 급랭", winDirection: "up" },
  { type: "momentum-cnn-sharp", title: "투자심리 급락", winDirection: "up" },
  { type: "momentum-cnn-weaken", title: "투자심리 악화", winDirection: "up" },
  { type: "momentum-cnn-surge", title: "투자심리 급반등", winDirection: "down" },
  { type: "momentum-cnn-recovery", title: "투자심리 회복", winDirection: "down" },
