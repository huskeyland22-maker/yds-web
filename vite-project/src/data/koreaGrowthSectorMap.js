 ...
 * }} KoreaSectorCard
 * @typedef {{ id: string; label: string; sectorId?: string }} IndustryFlowNode
 */
...
/**
 * 하단 산업 연결 맵 (국내 밸류체인 흐름)
 * @type {IndustryFlowNode[]}
 */
export const KOREA_INDUSTRY_FLOW = [
  { id: "ai", label: "AI", sectorId: "ai-infra" },
  { id: "power", label: "전력", sectorId: "power-grid" },
  { id: "transformer", label: "변압기", sectorId: "power-grid" },
  { id: "copper", label: "구리", sectorId: "copper-wire" },
  { id: "wire", label: "전선", sectorId: "copper-wire" },
  { id: "nuclear", label: "원전", sectorId: "nuclear" },
  { id: "robot", label: "로봇", sectorId: "robot-automation" },
]
