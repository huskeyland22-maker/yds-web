/**
 * 패닉 V1/V2 공통 상태 구간 (0~100) — 차트 배경·상단 상태 라벨
 */

/** @typedef {"stable" | "observe" | "caution" | "fear" | "panic"} PanicV2StatusId */
...
export const PANIC_V2_STATUS_BANDS = [
  ...
  { id: "observe", label: "관찰", min: 20, max: 40, toneClass: "panic-v2-status--transition" },
